...
var FunctionalComponent = function FunctionalComponent(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement("h1", props);
};
...
describe('VisibilityObserver', function () {
  it('adds a wrapped functional component to subscriber list', function () {
    var _render = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(FunctionalComponentWithIsVisible, null, "FunctionalComponentWithIsVisible")),
  ...
  it('removes a wrapped functional component from subscriber list on unmount', function () {
    var _render2 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(FunctionalComponentWithIsVisible, null, "FunctionalComponentWithIsVisible")),
  ...
  it('adds a wrapped class component to subscriber list', function () {
    var _render3 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(ClassComponentWithIsVisible, null, "ClassComponentWithIsVisible")),
  ...
  it('removes a wrapped class component from subscriber list on unmount', function () {
    var _render4 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(ClassComponentWithIsVisible, null, "ClassComponentWithIsVisible")),
  ...
  it('adds a functional component (hook) to subscriber list', function () {
    var _render5 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(FunctionalComponentHook, null, "FunctionalComponentHook")),
        getByText = _render5.getByText,
        unmount = _render5.unmount,
        rerender = _render5.rerender;

    rerender( /*#__PURE__*/_react["default"].createElement(FunctionalComponentHook, null, "FunctionalComponentHook"));
  ...
  it('removes a functional component (hook) from subscriber list on unmount', function () {
    var _render6 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(FunctionalComponentHook, null, "FunctionalComponentHook")),
  ...
  it('removes a wrapped class component from subscriber list on unmount', function () {
    var _render7 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(ClassComponentWithIsVisible, null, "ClassComponentWithIsVisible")),
