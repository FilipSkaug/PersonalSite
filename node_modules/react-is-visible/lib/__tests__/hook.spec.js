...
describe('useIsVisible', function () {
  it('renders', function () {
    var _render = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(FunctionalComponent, null, "Functional")),
        getByText = _render.getByText,
        rerender = _render.rerender;

    rerender( /*#__PURE__*/_react["default"].createElement(FunctionalComponent, null, "Functional"));
    expect(getByText('Functional')).toBeInTheDocument();
  });
  it('passes its state as props to a Functional Component', function () {
    var _render2 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(FunctionalComponent, null, "Functional")),
